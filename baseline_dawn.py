...
parser.add_argument('--qstates', type=int, default=255)
...
def main():
    ...
    train(model, opt, train_batches, test_batches, epochs, args.master_address, args.world_size, args.rank, loggers=(TableLogger(), TSV), timer=timer, test_time_in_total=False, qstates=args.qstates, memory=args.memory)
